function x = ALM_newiter(Q,q,A,a,ac,B,b,bc,rho,eta,eps,x0,lambda)
...
%     fprintf('QPM: Inner iteration = %d\n',k);
    ...
    for J1=1:nj1
        for J2=1:nj2
            ...
            A1 = A(:,:,1);
            a1 = a(:,1) - 2*BB1*x - bb1;
            aa1 = (2*BB1*x+bb1)'*x - x'*BB1*x - bb1'*x + ac(1) - bbc1 + lambda(1)/rho;
            A2 = A(:,:,2);
            a2 = a(:,2) - 2*BB2*x - bb2;
            aa2 = (2*BB2*x+bb2)'*x - x'*BB2*x - bb2'*x + ac(2) - bbc2 + lambda(2)/rho;
